 ...
 *******************************************************************************/
package cn.com.bjhj.baseframework.library.pulltorefresh.internal;
...
import cn.com.bjhj.baseframework.library.pulltorefresh.ILoadingLayout;
import cn.com.bjhj.baseframework.library.pulltorefresh.PullToRefreshBase;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
		...
		/*FrameLayout.LayoutParams fl = (LayoutParams) mHeaderImage.getLayoutParams();
		fl.width = DensityUtil.dip2px(context , 22);
		fl.height = DensityUtil.dip2px(context , 22);*/
